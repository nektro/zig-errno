...
pub const c = switch (builtin.target.os.tag) {
    ...
    .freebsd => opaque {
        ...
        pub const EPROTO = 92;
        pub const ENOTCAPABLE = 93;
        pub const ECAPMODE = 94;
    ...
    .netbsd => opaque {
        ...
        pub const EOVERFLOW = 84;
        pub const EILSEQ = 85;
        pub const ENOTSUP = 86;
        pub const ECANCELED = 87;
        pub const EBADMSG = 88;
        pub const ENODATA = 89;
        pub const ENOSR = 90;
        pub const ENOSTR = 91;
        pub const ETIME = 92;
        pub const ENOATTR = 93;
        pub const EMULTIHOP = 94;
        pub const ENOLINK = 95;
        pub const EPROTO = 96;
